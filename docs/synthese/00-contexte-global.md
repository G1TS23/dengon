...
| C-11 | Doc sécurité de référence = **`powl/04-security.md`** ; delta rédigé dans [`06-securite.md`](06-securite.md) (US-112) — ne reste que le résultat du Spike A (US-101, en cours). | tranché |
